...
impl<F: NibbleFlavor> NibbleSerializer<F> {
...
impl<'a, F> ser::Serializer for &'a mut NibbleSerializer<F>
where
    F: NibbleFlavor,
{
    type Ok = ();
...
impl<'a, F> ser::SerializeSeq for &'a mut NibbleSerializer<F>
where
    F: NibbleFlavor,
{
...
impl<'a, F> ser::SerializeTuple for &'a mut NibbleSerializer<F>
where
    F: NibbleFlavor,
{
    type Ok = ();
...
impl<'a, F> ser::SerializeTupleStruct for &'a mut NibbleSerializer<F>
where
    F: NibbleFlavor,
{
    type Ok = ();
...
impl<'a, F> ser::SerializeTupleVariant for &'a mut NibbleSerializer<F>
where
    F: NibbleFlavor,
{
    type Ok = ();
...
impl<'a, F> ser::SerializeMap for &'a mut NibbleSerializer<F>
where
    F: NibbleFlavor,
{
    type Ok = ();
...
impl<'a, F> ser::SerializeStruct for &'a mut NibbleSerializer<F>
where
    F: NibbleFlavor,
{
    type Ok = ();
...
impl<'a, F> ser::SerializeStructVariant for &'a mut NibbleSerializer<F>
where
    F: NibbleFlavor,
{
    type Ok = ();
